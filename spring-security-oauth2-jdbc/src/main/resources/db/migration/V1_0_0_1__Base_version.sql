...
CREATE SCHEMA IF NOT EXISTS `oauth2_new` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
...
values ('sysusr1','admin','Embrace','Admin','N','N','password','2014-10-10 10:10:05',NULL,NULL,NULL,NULL,'N');

insert  into `tbluser`(`user_id`,`user_name`,`first_name`,`last_name`,`is_inactive`,`is_locked`,`password`,`created_date`,`last_login_date`,`last_modified_date`,`created_by`,`last_modified_by`,`is_deleted`) 
values ('sysusr2','assetmanager','Asset','Manager','N','N','password','2014-10-10 10:10:05',NULL,NULL,NULL,NULL,'N');
