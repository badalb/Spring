package com.test.springsecurity.persistence.entity;
...
public class UserRolePK implements Serializable {
	...
	// @GenericGenerator(name = "hu_id_gen", strategy =
	// "com.homeunion.persistence.entities.util.HomeUnionIdGenerator")
